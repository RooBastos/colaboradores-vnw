...
public class DevFrontEnd extends Colaborador implements ColaboradorController {
	Scanner sc = new Scanner(System.in);
	
	private String senioridade;
	
	public DevFrontEnd(int numeroMatricula, String dataContratacao, String nome, String cpf, int idade, String genero,
			int conducoes, String modeloContratacao, String habilidadeTecnica, float salario, String senioridade) {
...
float novoSalario;
	...
	public void ValeAlimentacao() {
		float valeAlimentacao = 40 * 22;
		System.out.printf("O colaborador %s recebe R$%.2f de Vale Alimentação com base em 22 dias trabalhados e valor diário de R$40,00. \n", nome, valeAlimentacao);

	}

	@Override
	public void ValeRefeicao() {
		float valeRefeicao = 15 * 22;
		System.out.printf("O colaborador %s recebe R$%.2f de Vale Alimentação com base em 22 dias trabalhados e valor diário de R$15,00. \n", nome, valeRefeicao);
