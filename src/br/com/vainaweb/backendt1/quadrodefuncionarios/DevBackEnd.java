...
public class DevBackEnd extends Colaborador implements ColaboradorController {
	Scanner sc = new Scanner(System.in);
	
	private String senioridade;
	
	public DevBackEnd(int numeroMatricula, String dataContratacao, String nome, String cpf, int idade, String genero,
	...
	public void ValeAlimentacao() {
		float valeAlimentacao = 45 * 22;
		System.out.printf("O colaborador %s recebe R$%.2f de Vale Alimentação com base em 22 dias trabalhados e valor diário de R$45,00. \n", nome, valeAlimentacao);

	}

	@Override
	public void ValeRefeicao() {
		float valeRefeicao = 17 * 22;
		System.out.printf("O colaborador %s recebe R$%.2f de Vale Alimentação com base em 22 dias trabalhados e valor diário de R$17,00. \n", nome, valeRefeicao);
